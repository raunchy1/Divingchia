          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
            ...
            <ScrollReveal delay={0.2}>
              <div className="p-8 md:p-12" style={{ backgroundColor: "#FAFAF8" }}>
                ...
                <div className="mb-8">
                  <span
                    className="font-cormorant text-[48px] font-light leading-none"
                    style={{ color: "#1a1a1a" }}
                  >
                    Su Richiesta
                  </span>
                </div>
                <p className="mb-4 font-jost text-[15px] font-light leading-[1.7]" style={{ color: "#6b6b6b" }}>
                  Contattaci via WhatsApp per un preventivo personalizzato in base al numero di persone, alla durata e alle attivit&agrave; desiderate.
                </p>
                <p className="mb-8 font-jost text-[13px] font-light" style={{ color: "#9a9a9a" }}>
                  Contact us on WhatsApp for a personalised quote.
                </p>
                <a
                  href={getWhatsAppLink()}
                  target="_blank"
